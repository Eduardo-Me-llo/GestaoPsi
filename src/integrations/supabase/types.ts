  ...
  public: {
    Tables: {
      ...
      wheel_entries: {
        ...
        Relationships: [
          {
            foreignKeyName: "wheel_entries_client_id_fkey"
            columns: ["client_id"]
            isOneToOne: false
            referencedRelation: "clients"
            referencedColumns: ["id"]
    ...
    Enums: {
      client_status: "ativo" | "inativo" | "desistente" | "alta" | "espera"
      plan_type: "sessao" | "mensalidade"
      session_status: "agendada" | "realizada" | "faltou" | "cancelada"
      transaction_kind: "receita" | "despesa"
      wheel_type: "adolescente" | "adulto"
    }
    CompositeTypes: {
      [_ in never]: never
    }
