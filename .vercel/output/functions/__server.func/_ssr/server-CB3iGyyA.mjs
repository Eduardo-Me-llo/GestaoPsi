...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C9OFP5QW.mjs");
...
const manifest = {
  "526722240008cc99e8a1dd6761c7ffbfad1ae2f2e1bfd6fa34f9c6e70feba48b": {
    functionName: "adminCreatePsychologist_createServerFn_handler",
    importer: () => import("./admin-actions-Baawxra0.mjs")
  },
  "818d112ffd204d16765582650393988d28f70ed6b7361fb331219be531fd2639": {
    functionName: "adminSetPassword_createServerFn_handler",
    importer: () => import("./admin-actions-Baawxra0.mjs")
  },
  "94cf72aa92a2baa3dc6328b2369e81aa994d25b2ce7dea8f80e6baf8f024d4d0": {
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-C0lyWhsY.mjs").then((n) => n.r),
    import("./start-V4IeOAzu.mjs"),
